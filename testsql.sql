...
CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.infoschema`@`localhost` SQL SECURITY DEFINER VIEW `information_schema`.`ROLE_COLUMN_GRANTS` AS with recursive `role_graph` (`c_parent_user`,`c_parent_host`,`c_from_user`,`c_from_host`,`c_to_user`,`c_to_host`,`role_path`,`c_with_admin`,`c_enabled`) as (select internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,cast('' as char(64) charset utf8mb4) AS `CAST('' as CHAR(64) CHARSET utf8mb4)`,cast('' as char(255) charset utf8mb4) AS `CAST('' as CHAR(255) CHARSET utf8mb4)`,cast(sha2(concat(quote(internal_get_username()),'@',quote(internal_get_hostname())),256) as char(17000) charset utf8mb4) AS `CAST(SHA2(CONCAT(QUOTE(INTERNAL_GET_USERNAME()),'@',                        QUOTE(INTERNAL_GET_HOSTNAME())), 256)            AS CHAR(17000) CHARSET utf8mb4)`,cast('N' as char(1) charset utf8mb4) AS `CAST('N' as CHAR(1) CHARSET utf8mb4)`,false AS `FALSE` union select internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,`mandatory_roles`.`ROLE_NAME` AS `ROLE_NAME`,`mandatory_roles`.`ROLE_HOST` AS `ROLE_HOST`,internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,cast(sha2(concat(quote(`mandatory_roles`.`ROLE_NAME`),'@',convert(quote(`mandatory_roles`.`ROLE_HOST`) using utf8mb4)),256) as char(17000) charset utf8mb4) AS `CAST(SHA2(CONCAT(QUOTE(ROLE_NAME),'@',                   CONVERT(QUOTE(ROLE_HOST) using utf8mb4)), 256)              AS CHAR(17000) CHARSET utf8mb4)`,cast('N' as char(1) charset utf8mb4) AS `CAST('N' as CHAR(1) CHARSET utf8mb4)`,false AS `FALSE` from json_table(internal_get_mandatory_roles_json(), '$[*]' columns (`ROLE_NAME` varchar(255) character set utf8mb4 path '$.ROLE_NAME', `ROLE_HOST` varchar(255) character set utf8mb4 path '$.ROLE_HOST')) `mandatory_roles` where concat(quote(`mandatory_roles`.`ROLE_NAME`),'@',convert(quote(`mandatory_roles`.`ROLE_HOST`) using utf8mb4)) in (select concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)) from `mysql`.`role_edges` where ((`mysql`.`role_edges`.`TO_USER` = internal_get_username()) and (convert(`mysql`.`role_edges`.`TO_HOST` using utf8mb4) = convert(internal_get_hostname() using utf8mb4)))) is false union select `role_graph`.`c_parent_user` AS `c_parent_user`,`role_graph`.`c_parent_host` AS `c_parent_host`,`mysql`.`role_edges`.`FROM_USER` AS `FROM_USER`,`mysql`.`role_edges`.`FROM_HOST` AS `FROM_HOST`,`mysql`.`role_edges`.`TO_USER` AS `TO_USER`,`mysql`.`role_edges`.`TO_HOST` AS `TO_HOST`,if((locate(convert(sha2(concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)),256) using utf8mb4),`role_graph`.`role_path`) = 0),concat(`role_graph`.`role_path`,'->',convert(sha2(concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)),256) using utf8mb4)),NULL) AS `IF(LOCATE(SHA2(CONCAT(QUOTE(FROM_USER),'@',                      CONVERT(QUOTE(FROM_HOST) using utf8mb4)), 256),                 role_path) = 0,          CONCAT(role_path,'->', SHA2(CONCAT(QUOTE(FROM_USER),'@',           CONVERT(QUOTE(FROM_HOST) using utf8`,`mysql`.`role_edges`.`WITH_ADMIN_OPTION` AS `WITH_ADMIN_OPTION`,if(((0 <> `role_graph`.`c_enabled`) or (0 <> internal_is_enabled_role(`mysql`.`role_edges`.`FROM_USER`,`mysql`.`role_edges`.`FROM_HOST`))),true,false) AS `IF(c_enabled OR        INTERNAL_IS_ENABLED_ROLE(FROM_USER, FROM_HOST), TRUE, FALSE)` from (`mysql`.`role_edges` join `role_graph`) where ((convert(`mysql`.`role_edges`.`TO_USER` using utf8mb4) = `role_graph`.`c_from_user`) and (convert(`mysql`.`role_edges`.`TO_HOST` using utf8mb4) = `role_graph`.`c_from_host`) and (`role_graph`.`role_path` is not null))) select distinct internal_get_username(`tp`.`Grantor`) AS `GRANTOR`,internal_get_hostname(`tp`.`Grantor`) AS `GRANTOR_HOST`,`cp`.`User` AS `GRANTEE`,`cp`.`Host` AS `GRANTEE_HOST`,'def' AS `TABLE_IF NOT EXISTS CATALOG`,`cp`.`Db` AS `TABLE_SCHEMA`,`cp`.`Table_name` AS `TABLE_NAME`,`cp`.`Column_name` AS `COLUMN_NAME`,`cp`.`Column_priv` AS `PRIVILEGE_TYPE`,if((find_in_set('Grant',`tp`.`Table_priv`) > 0),'YES','NO') AS `IS_GRANTABLE` from ((`mysql`.`tables_priv` `tp` join `role_graph` `rg` on(((convert(`tp`.`User` using utf8mb4) = `rg`.`c_from_user`) and (convert(`tp`.`Host` using utf8mb4) = `rg`.`c_from_host`)))) join `mysql`.`columns_priv` `cp` on(((convert(`tp`.`Host` using utf8mb4) = convert(`cp`.`Host` using utf8mb4)) and (`cp`.`Db` = `tp`.`Db`) and (`cp`.`User` = `tp`.`User`) and (`cp`.`Table_name` = `tp`.`Table_name`)))) where ((`cp`.`Column_priv` > 0) and (`rg`.`c_to_user` <> '') and (`rg`.`c_enabled` = true));

-- Data exporting was unselected.

-- Dumping structure for table information_schema.ROLE_ROUTINE_GRANTS
DROP TABLE IF EXISTS `ROLE_ROUTINE_GRANTS`;
CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.infoschema`@`localhost` SQL SECURITY DEFINER VIEW `information_schema`.`ROLE_ROUTINE_GRANTS` AS with recursive `role_graph` (`c_parent_user`,`c_parent_host`,`c_from_user`,`c_from_host`,`c_to_user`,`c_to_host`,`role_path`,`c_with_admin`,`c_enabled`) as (select internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,cast('' as char(64) charset utf8mb4) AS `CAST('' as CHAR(64) CHARSET utf8mb4)`,cast('' as char(255) charset utf8mb4) AS `CAST('' as CHAR(255) CHARSET utf8mb4)`,cast(sha2(concat(quote(internal_get_username()),'@',quote(internal_get_hostname())),256) as char(17000) charset utf8mb4) AS `CAST(SHA2(CONCAT(QUOTE(INTERNAL_GET_USERNAME()),'@',                        QUOTE(INTERNAL_GET_HOSTNAME())), 256)            AS CHAR(17000) CHARSET utf8mb4)`,cast('N' as char(1) charset utf8mb4) AS `CAST('N' as CHAR(1) CHARSET utf8mb4)`,false AS `FALSE` union select internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,`mandatory_roles`.`ROLE_NAME` AS `ROLE_NAME`,`mandatory_roles`.`ROLE_HOST` AS `ROLE_HOST`,internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,cast(sha2(concat(quote(`mandatory_roles`.`ROLE_NAME`),'@',convert(quote(`mandatory_roles`.`ROLE_HOST`) using utf8mb4)),256) as char(17000) charset utf8mb4) AS `CAST(SHA2(CONCAT(QUOTE(ROLE_NAME),'@',                   CONVERT(QUOTE(ROLE_HOST) using utf8mb4)), 256)              AS CHAR(17000) CHARSET utf8mb4)`,cast('N' as char(1) charset utf8mb4) AS `CAST('N' as CHAR(1) CHARSET utf8mb4)`,false AS `FALSE` from json_table(internal_get_mandatory_roles_json(), '$[*]' columns (`ROLE_NAME` varchar(255) character set utf8mb4 path '$.ROLE_NAME', `ROLE_HOST` varchar(255) character set utf8mb4 path '$.ROLE_HOST')) `mandatory_roles` where concat(quote(`mandatory_roles`.`ROLE_NAME`),'@',convert(quote(`mandatory_roles`.`ROLE_HOST`) using utf8mb4)) in (select concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)) from `mysql`.`role_edges` where ((`mysql`.`role_edges`.`TO_USER` = internal_get_username()) and (convert(`mysql`.`role_edges`.`TO_HOST` using utf8mb4) = convert(internal_get_hostname() using utf8mb4)))) is false union select `role_graph`.`c_parent_user` AS `c_parent_user`,`role_graph`.`c_parent_host` AS `c_parent_host`,`mysql`.`role_edges`.`FROM_USER` AS `FROM_USER`,`mysql`.`role_edges`.`FROM_HOST` AS `FROM_HOST`,`mysql`.`role_edges`.`TO_USER` AS `TO_USER`,`mysql`.`role_edges`.`TO_HOST` AS `TO_HOST`,if((locate(convert(sha2(concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)),256) using utf8mb4),`role_graph`.`role_path`) = 0),concat(`role_graph`.`role_path`,'->',convert(sha2(concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)),256) using utf8mb4)),NULL) AS `IF(LOCATE(SHA2(CONCAT(QUOTE(FROM_USER),'@',                      CONVERT(QUOTE(FROM_HOST) using utf8mb4)), 256),                 role_path) = 0,          CONCAT(role_path,'->', SHA2(CONCAT(QUOTE(FROM_USER),'@',           CONVERT(QUOTE(FROM_HOST) using utf8`,`mysql`.`role_edges`.`WITH_ADMIN_OPTION` AS `WITH_ADMIN_OPTION`,if(((0 <> `role_graph`.`c_enabled`) or (0 <> internal_is_enabled_role(`mysql`.`role_edges`.`FROM_USER`,`mysql`.`role_edges`.`FROM_HOST`))),true,false) AS `IF(c_enabled OR        INTERNAL_IS_ENABLED_ROLE(FROM_USER, FROM_HOST), TRUE, FALSE)` from (`mysql`.`role_edges` join `role_graph`) where ((convert(`mysql`.`role_edges`.`TO_USER` using utf8mb4) = `role_graph`.`c_from_user`) and (convert(`mysql`.`role_edges`.`TO_HOST` using utf8mb4) = `role_graph`.`c_from_host`) and (`role_graph`.`role_path` is not null))) select distinct internal_get_username(`pp`.`Grantor`) AS `GRANTOR`,internal_get_hostname(`pp`.`Grantor`) AS `GRANTOR_HOST`,`pp`.`User` AS `GRANTEE`,`pp`.`Host` AS `GRANTEE_HOST`,'def' AS `SPECIFIC_CATALOG`,`pp`.`Db` AS `SPECIFIC_SCHEMA`,`pp`.`Routine_name` AS `SPECIFIC_NAME`,'def' AS `ROUTINE_CATALOG`,`pp`.`Db` AS `ROUTINE_SCHEMA`,`pp`.`Routine_name` AS `ROUTINE_NAME`,`pp`.`Proc_priv` AS `PRIVILEGE_TYPE`,if((find_in_set('Grant',`pp`.`Proc_priv`) > 0),'YES','NO') AS `IS_GRANTABLE`IF NOT EXISTS  from (`mysql`.`procs_priv` `pp` join `role_graph` `rg` on(((convert(`pp`.`User` using utf8mb4) = `rg`.`c_from_user`) and (convert(`pp`.`Host` using utf8mb4) = `rg`.`c_from_host`)))) where ((`pp`.`Proc_priv` > 0) and (`rg`.`c_to_user` <> '') and (`rg`.`c_enabled` = true));

-- Data exporting was unselected.

-- Dumping structure for table information_schema.ROLE_TABLE_GRANTS
DROP TABLE IF EXISTS `ROLE_TABLE_GRANTS`;
CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.infoschema`@`localhost` SQL SECURITY DEFINER VIEW `information_schema`.`ROLE_TABLE_IF NOT EXISTS GRANTS` AS with recursive `role_graph` (`c_parent_user`,`c_parent_host`,`c_from_user`,`c_from_host`,`c_to_user`,`c_to_host`,`role_path`,`c_with_admin`,`c_enabled`) as (select internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,cast('' as char(64) charset utf8mb4) AS `CAST('' as CHAR(64) CHARSET utf8mb4)`,cast('' as char(255) charset utf8mb4) AS `CAST('' as CHAR(255) CHARSET utf8mb4)`,cast(sha2(concat(quote(internal_get_username()),'@',quote(internal_get_hostname())),256) as char(17000) charset utf8mb4) AS `CAST(SHA2(CONCAT(QUOTE(INTERNAL_GET_USERNAME()),'@',                        QUOTE(INTERNAL_GET_HOSTNAME())), 256)            AS CHAR(17000) CHARSET utf8mb4)`,cast('N' as char(1) charset utf8mb4) AS `CAST('N' as CHAR(1) CHARSET utf8mb4)`,false AS `FALSE` union select internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,`mandatory_roles`.`ROLE_NAME` AS `ROLE_NAME`,`mandatory_roles`.`ROLE_HOST` AS `ROLE_HOST`,internal_get_username() AS `INTERNAL_GET_USERNAME()`,internal_get_hostname() AS `INTERNAL_GET_HOSTNAME()`,cast(sha2(concat(quote(`mandatory_roles`.`ROLE_NAME`),'@',convert(quote(`mandatory_roles`.`ROLE_HOST`) using utf8mb4)),256) as char(17000) charset utf8mb4) AS `CAST(SHA2(CONCAT(QUOTE(ROLE_NAME),'@',                   CONVERT(QUOTE(ROLE_HOST) using utf8mb4)), 256)              AS CHAR(17000) CHARSET utf8mb4)`,cast('N' as char(1) charset utf8mb4) AS `CAST('N' as CHAR(1) CHARSET utf8mb4)`,false AS `FALSE` from json_table(internal_get_mandatory_roles_json(), '$[*]' columns (`ROLE_NAME` varchar(255) character set utf8mb4 path '$.ROLE_NAME', `ROLE_HOST` varchar(255) character set utf8mb4 path '$.ROLE_HOST')) `mandatory_roles` where concat(quote(`mandatory_roles`.`ROLE_NAME`),'@',convert(quote(`mandatory_roles`.`ROLE_HOST`) using utf8mb4)) in (select concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)) from `mysql`.`role_edges` where ((`mysql`.`role_edges`.`TO_USER` = internal_get_username()) and (convert(`mysql`.`role_edges`.`TO_HOST` using utf8mb4) = convert(internal_get_hostname() using utf8mb4)))) is false union select `role_graph`.`c_parent_user` AS `c_parent_user`,`role_graph`.`c_parent_host` AS `c_parent_host`,`mysql`.`role_edges`.`FROM_USER` AS `FROM_USER`,`mysql`.`role_edges`.`FROM_HOST` AS `FROM_HOST`,`mysql`.`role_edges`.`TO_USER` AS `TO_USER`,`mysql`.`role_edges`.`TO_HOST` AS `TO_HOST`,if((locate(convert(sha2(concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)),256) using utf8mb4),`role_graph`.`role_path`) = 0),concat(`role_graph`.`role_path`,'->',convert(sha2(concat(convert(quote(`mysql`.`role_edges`.`FROM_USER`) using utf8mb4),'@',convert(quote(`mysql`.`role_edges`.`FROM_HOST`) using utf8mb4)),256) using utf8mb4)),NULL) AS `IF(LOCATE(SHA2(CONCAT(QUOTE(FROM_USER),'@',                      CONVERT(QUOTE(FROM_HOST) using utf8mb4)), 256),                 role_path) = 0,          CONCAT(role_path,'->', SHA2(CONCAT(QUOTE(FROM_USER),'@',           CONVERT(QUOTE(FROM_HOST) using utf8`,`mysql`.`role_edges`.`WITH_ADMIN_OPTION` AS `WITH_ADMIN_OPTION`,if(((0 <> `role_graph`.`c_enabled`) or (0 <> internal_is_enabled_role(`mysql`.`role_edges`.`FROM_USER`,`mysql`.`role_edges`.`FROM_HOST`))),true,false) AS `IF(c_enabled OR        INTERNAL_IS_ENABLED_ROLE(FROM_USER, FROM_HOST), TRUE, FALSE)` from (`mysql`.`role_edges` join `role_graph`) where ((convert(`mysql`.`role_edges`.`TO_USER` using utf8mb4) = `role_graph`.`c_from_user`) and (convert(`mysql`.`role_edges`.`TO_HOST` using utf8mb4) = `role_graph`.`c_from_host`) and (`role_graph`.`role_path` is not null))) select distinct internal_get_username(`tp`.`Grantor`) AS `GRANTOR`,internal_get_hostname(`tp`.`Grantor`) AS `GRANTOR_HOST`,`tp`.`User` AS `GRANTEE`,`tp`.`Host` AS `GRANTEE_HOST`,'def' AS `TABLE_CATALOG`,`tp`.`Db` AS `TABLE_SCHEMA`,`tp`.`Table_name` AS `TABLE_NAME`,`tp`.`Table_priv` AS `PRIVILEGE_TYPE`,if((find_in_set('Grant',`tp`.`Table_priv`) > 0),'YES','NO') AS `IS_GRANTABLE` from (`mysql`.`tables_priv` `tp` join `role_graph` `rg` on(((convert(`tp`.`User` using utf8mb4) = `rg`.`c_from_user`) and (convert(`tp`.`Host` using utf8mb4) = `rg`.`c_from_host`)))) where ((`tp`.`Table_priv` > 0) and (`rg`.`c_to_user` <> '') and (`rg`.`c_enabled` = true));
...
CREATIF NOT EXISTS E ALGORITHM=UNDEFINED DEFINER=`mysql.infoschema`@`localhost` SQL SECURITY DEFINER VIEW `information_schema`.`USER_ATTRIBUTES` AS select `mysql`.`user`.`User` AS `USER`,`mysql`.`user`.`Host` AS `HOST`,json_unquote(json_extract(`mysql`.`user`.`User_attributes`,'$.metadata')) AS `ATTRIBUTE` from `mysql`.`user`;
...
CREATE TABLE `host_summary` (
	...
	`statement_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`statement_avg_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`table_scans` DECIMAL(65,0) NULL,
	`file_ios` DECIMAL(64,0) NULL,
	`file_io_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_users` BIGINT(19,0) NOT NULL,
	`current_memory` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`total_memory_allocated` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io` (
	...
	`io_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io_type` (
	...
	`total` BIGINT(20,0) NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_stages` (
	...
	`total` BIGINT(20,0) NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`avg_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_statement_latency` (
	...
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`lock_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `host_summary_by_statement_type` (
	...
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`lock_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_sent` BIGINT(20,0) NOT NULL,
	`rows_examined` BIGINT(20,0) NOT NULL,
	`rows_affected` BIGINT(20,0) NOT NULL,
	`full_scans` BIGINT(20,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `innodb_buffer_stats_by_schema` (
	...
	`allocated` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`data` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`pages` BIGINT(19,0) NOT NULL,
	`pages_hashed` BIGINT(19,0) NOT NULL,
	`pages_old` BIGINT(19,0) NOT NULL,
...
CREATE TABLE `innodb_lock_waits` (
	...
	`wait_age` TIME NULL,
	`wait_age_secs` BIGINT(19,0) NULL,
	...
	`waiting_trx_id` BIGINT(20,0) NOT NULL,
	`waiting_trx_started` DATETIME NOT NULL,
	`waiting_trx_age` TIME NULL,
	`waiting_trx_rows_locked` BIGINT(20,0) NOT NULL,
	`waiting_trx_rows_modified` BIGINT(20,0) NOT NULL,
	`waiting_pid` BIGINT(20,0) NOT NULL,
	...
	`blocking_trx_id` BIGINT(20,0) NOT NULL,
	`blocking_pid` BIGINT(20,0) NOT NULL,
	...
	`blocking_trx_rows_locked` BIGINT(20,0) NOT NULL,
	`blocking_trx_rows_modified` BIGINT(20,0) NOT NULL,
...
CREATE TABLE `io_by_thread_by_latency` (
	...
	`total` DECIMAL(42,0) NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`min_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`avg_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`thread_id` BIGINT(20,0) NOT NULL,
	`processlist_id` BIGINT(20,0) NULL
) ENGINE=MyISAM;
...
CREATE TABLE `io_global_by_file_by_bytes` (
	...
	`count_read` BIGINT(20,0) NOT NULL,
	`total_read` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`avg_read` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`count_write` BIGINT(20,0) NOT NULL,
	`total_written` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`avg_write` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`total` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `io_global_by_file_by_latency` (
	...
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`count_read` BIGINT(20,0) NOT NULL,
	`read_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`count_write` BIGINT(20,0) NOT NULL,
	`write_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`count_misc` BIGINT(20,0) NOT NULL,
	`misc_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `io_global_by_wait_by_bytes` (
	...
	`count_write` BIGINT(20,0) NOT NULL,
	`total_written` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`avg_written` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`total_requested` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `latest_file_io` (
	...
	`file` VARCHAR(512) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`operation` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`requested` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_by_host_by_current_bytes` (
	...
	`current_allocated` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`current_avg_alloc` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`current_max_alloc` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`total_allocated` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_global_by_current_bytes` (
	`event_name` VARCHAR(128) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`current_count` BIGINT(19,0) NOT NULL,
	`current_alloc` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`current_avg_alloc` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`high_count` BIGINT(19,0) NOT NULL,
	`high_alloc` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`high_avg_alloc` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `metrics` (
	...
	`Variable_value` TEXT(65535) NULL COLLATE 'utf8mb4_0900_ai_ci',
...
CREATE TABLE `processlist` (
	`thd_id` BIGINT(20,0) NOT NULL,
	`conn_id` BIGINT(20,0) NULL,
	`user` VARCHAR(288) NULL COLLATE 'utf8mb4_0900_ai_ci',
	...
	`time` BIGINT(19,0) NULL,
	`current_statement` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`statement_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`progress` DECIMAL(26,2) NULL,
	`lock_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_examined` BIGINT(20,0) NULL,
	`rows_sent` BIGINT(20,0) NULL,
	`rows_affected` BIGINT(20,0) NULL,
	`tmp_tables` BIGINT(20,0) NULL,
	`tmp_disk_tables` BIGINT(20,0) NULL,
	`full_scan` VARCHAR(3) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_statement` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_statement_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`current_memory` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	...
	`trx_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `schema_auto_increment_columns` (
	...
	`is_signed` INT(10,0) NOT NULL,
	`is_unsigned` INT(10,0) NOT NULL,
	`max_value` BIGINT(20,0) NULL,
	`auto_increment` BIGINT(20,0) NULL,
...
CREATE TABLE `schema_index_statistics` (
	...
	`rows_selected` BIGINT(20,0) NOT NULL,
	`select_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_inserted` BIGINT(20,0) NOT NULL,
	`insert_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_updated` BIGINT(20,0) NOT NULL,
	`update_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_deleted` BIGINT(20,0) NOT NULL,
	`delete_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_redundant_indexes` (
	...
	`redundant_index_columns` TEXT(65535) NULL COLLATE 'utf8_tolower_ci',
	`redundant_index_non_unique` INT(10,0) NULL,
	`dominant_index_name` VARCHAR(64) NULL COLLATE 'utf8_tolower_ci',
	`dominant_index_columns` TEXT(65535) NULL COLLATE 'utf8_tolower_ci',
	`dominant_index_non_unique` INT(10,0) NULL,
	`subpart_exists` INT(10,0) NOT NULL,
...
CREATE TABLE `schema_tables_with_full_table_scans` (
	...
	`rows_full_scanned` BIGINT(20,0) NOT NULL,
	`latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_table_lock_waits` (
	`object_schema` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`object_name` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_thread_id` BIGINT(20,0) NOT NULL,
	`waiting_pid` BIGINT(20,0) NULL,
	`waiting_account` TEXT(65535) NULL COLLATE 'utf8mb4_0900_ai_ci',
	...
	`waiting_query` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_query_secs` BIGINT(19,0) NULL,
	`waiting_query_rows_affected` BIGINT(20,0) NULL,
	`waiting_query_rows_examined` BIGINT(20,0) NULL,
	`blocking_thread_id` BIGINT(20,0) NOT NULL,
	`blocking_pid` BIGINT(20,0) NULL,
	`blocking_account` TEXT(65535) NULL COLLATE 'utf8mb4_0900_ai_ci',
...
CREATE TABLE `schema_table_statistics` (
	...
	`table_name` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_fetched` BIGINT(20,0) NOT NULL,
	`fetch_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_inserted` BIGINT(20,0) NOT NULL,
	`insert_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_updated` BIGINT(20,0) NOT NULL,
	`update_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	...
	`io_read` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`io_read_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`io_write_requests` DECIMAL(42,0) NULL,
	`io_write` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`io_write_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_table_statistics_with_buffer` (
	...
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_allocated` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_data` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_free` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`innodb_buffer_pages` BIGINT(19,0) NULL,
	`innodb_buffer_pages_hashed` BIGINT(19,0) NULL,
	`innodb_buffer_pages_old` BIGINT(19,0) NULL,
...
CREATE TABLE `statements_with_errors_or_warnings` (
	...
	`db` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`exec_count` BIGINT(20,0) NOT NULL,
	`errors` BIGINT(20,0) NOT NULL,
	`error_pct` DECIMAL(27,4) NOT NULL,
	`warnings` BIGINT(20,0) NOT NULL,
...
CREATE TABLE `statements_with_full_table_scans` (
	...
	`exec_count` BIGINT(20,0) NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`no_index_used_count` BIGINT(20,0) NOT NULL,
	`no_good_index_used_count` BIGINT(20,0) NOT NULL,
...
CREATE TABLE `statements_with_runtimes_in_95th_percentile` (
	...
	`exec_count` BIGINT(20,0) NOT NULL,
	`err_count` BIGINT(20,0) NOT NULL,
	`warn_count` BIGINT(20,0) NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`avg_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`rows_sent` BIGINT(20,0) NOT NULL,
...
CREATE TABLE `statements_with_sorting` (
	...
	`exec_count` BIGINT(20,0) NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`sort_merge_passes` BIGINT(20,0) NOT NULL,
	`avg_sort_merges` DECIMAL(21,0) NOT NULL,
	`sorts_using_scans` BIGINT(20,0) NOT NULL,
	`sort_using_range` BIGINT(20,0) NOT NULL,
	`rows_sorted` BIGINT(20,0) NOT NULL,
...
CREATE TABLE `statements_with_temp_tables` (
	...
	`exec_count` BIGINT(20,0) NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`memory_tmp_tables` BIGINT(20,0) NOT NULL,
	`disk_tmp_tables` BIGINT(20,0) NOT NULL,
...
CREATE TABLE `statement_analysis` (
	...
	`tmp_tables` BIGINT(20,0) NOT NULL,
	`tmp_disk_tables` BIGINT(20,0) NOT NULL,
	`rows_sorted` BIGINT(20,0) NOT NULL,
	`sort_merge_passes` BIGINT(20,0) NOT NULL,
	`digest` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`first_seen` TIMESTAMP(6) NOT NULL,
...
CREATE TABLE `user_summary` (
	...
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_hosts` BIGINT(19,0) NOT NULL,
	`current_memory` VARCHAR(11) NULL COLLATE 'utf8_general_ci',
	`total_memory_allocated` VARCHAR(11) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `x$host_summary_by_file_io_type` (
	...
	`event_name` VARCHAR(128) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` BIGINT(20,0) NOT NULL,
	`total_latency` BIGINT(20,0) NOT NULL,
	`max_latency` BIGINT(20,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$host_summary_by_stages` (
	...
	`total` BIGINT(20,0) NOT NULL,
	`total_latency` BIGINT(20,0) NOT NULL,
	`avg_latency` BIGINT(20,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$host_summary_by_statement_type` (
	...
	`total_latency` BIGINT(20,0) NOT NULL,
	`max_latency` BIGINT(20,0) NOT NULL,
	`lock_latency` BIGINT(20,0) NOT NULL,
	`rows_sent` BIGINT(20,0) NOT NULL,
	`rows_examined` BIGINT(20,0) NOT NULL,
	`rows_affected` BIGINT(20,0) NOT NULL,
	`full_scans` BIGINT(20,0) NOT NULL
...
CREATE TABLE `x$io_global_by_file_by_bytes` (
	...
	`count_read` BIGINT(20,0) NOT NULL,
	`total_read` BIGINT(19,0) NOT NULL,
	`avg_read` DECIMAL(23,4) NOT NULL,
	`count_write` BIGINT(20,0) NOT NULL,
	`total_written` BIGINT(19,0) NOT NULL,
	`avg_write` DECIMAL(23,4) NOT NULL,
	`total` BIGINT(19,0) NOT NULL,
	`write_pct` DECIMAL(26,2) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$io_global_by_file_by_latency` (
	...
	`total_latency` BIGINT(20,0) NOT NULL,
	`count_read` BIGINT(20,0) NOT NULL,
	`read_latency` BIGINT(20,0) NOT NULL,
	`count_write` BIGINT(20,0) NOT NULL,
	`write_latency` BIGINT(20,0) NOT NULL,
	`count_misc` BIGINT(20,0) NOT NULL,
	`misc_latency` BIGINT(20,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$io_global_by_wait_by_bytes` (
	...
	`total` BIGINT(20,0) NOT NULL,
	`total_latency` BIGINT(20,0) NOT NULL,
	`min_latency` BIGINT(20,0) NOT NULL,
	`avg_latency` BIGINT(20,0) NOT NULL,
	`max_latency` BIGINT(20,0) NOT NULL,
	`count_read` BIGINT(20,0) NOT NULL,
	`total_read` BIGINT(19,0) NOT NULL,
	...
	`total_requested` BIGINT(19,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$latest_file_io` (
	`thread` VARCHAR(316) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`file` VARCHAR(512) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`latency` BIGINT(20,0) NULL,
	`operation` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`requested` BIGINT(19,0) NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$memory_by_host_by_current_bytes` (
	...
	`current_max_alloc` BIGINT(19,0) NULL,
...
CREATE TABLE `x$memory_global_by_current_bytes` (
	`event_name` VARCHAR(128) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`current_count` BIGINT(19,0) NOT NULL,
	`current_alloc` BIGINT(19,0) NOT NULL,
	`current_avg_alloc` DECIMAL(23,4) NOT NULL,
	`high_count` BIGINT(19,0) NOT NULL,
	`high_alloc` BIGINT(19,0) NOT NULL,
...
CREATE TABLE `x$processlist` (
	...
	`time` BIGINT(19,0) NULL,
	`current_statement` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`statement_latency` BIGINT(20,0) NULL,
	`progress` DECIMAL(26,2) NULL,
	`lock_latency` BIGINT(20,0) NULL,
	`rows_examined` BIGINT(20,0) NULL,
	`rows_sent` BIGINT(20,0) NULL,
	`rows_affected` BIGINT(20,0) NULL,
	`tmp_tables` BIGINT(20,0) NULL,
...
CREATE TABLE `x$schema_flattened_keys` (
	...
	`non_unique` INT(10,0) NULL,
	`subpart_exists` BIGINT(19,0) NULL,
	`index_columns` TEXT(65535) NULL COLLATE 'utf8_tolower_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `x$schema_index_statistics` (
	...
	`index_name` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`rows_selected` BIGINT(20,0) NOT NULL,
	`select_latency` BIGINT(20,0) NOT NULL,
	`rows_inserted` BIGINT(20,0) NOT NULL,
	`insert_latency` BIGINT(20,0) NOT NULL,
	`rows_updated` BIGINT(20,0) NOT NULL,
	`update_latency` BIGINT(20,0) NOT NULL,
	`rows_deleted` BIGINT(20,0) NOT NULL,
	`delete_latency` BIGINT(20,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$schema_table_statistics` (
	...
	`total_latency` BIGINT(20,0) NOT NULL,
	`rows_fetched` BIGINT(20,0) NOT NULL,
	`fetch_latency` BIGINT(20,0) NOT NULL,
	`rows_inserted` BIGINT(20,0) NOT NULL,
	`insert_latency` BIGINT(20,0) NOT NULL,
	`rows_updated` BIGINT(20,0) NOT NULL,
	`update_latency` BIGINT(20,0) NOT NULL,
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `sys`.`x$host_summary_by_statement_latency` (`host`,`total`,`total_latency`,`max_latency`,`lock_latency`,`rows_sent`,`rows_examined`,`rows_affected`,`full_scans`) AS select if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) AS `host`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,max(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME`) AS `lock_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT`) AS `rows_sent`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED`) AS `rows_examined`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED`) AS `rows_affected`,(sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED`) + sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`)) AS `full_scans` from `performance_schema`.`events_statements_summary_by_host_by_event_name` group by if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) order by sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) desc;

-- Dumping structure for view sys.x$host_summary_by_statement_type
DROP VIEW IF EXISTS `x$host_summary_by_statement_type`;
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `x$host_summary_by_statement_type`;
CREATE ALGORITHM=MERGE SQL SECURITY INVOKER VIEW `sys`.`x$host_summary_by_statement_type` (`host`,`statement`,`total`,`total_latency`,`max_latency`,`lock_latency`,`rows_sent`,`rows_examined`,`rows_affected`,`full_scans`) AS select if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) AS `host`,substring_index(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`EVENT_NAME`,'/',-(1)) AS `statement`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR` AS `total`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT` AS `total_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT` AS `max_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME` AS `lock_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT` AS `rows_sent`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED` AS `rows_examined`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED` AS `rows_affected`,(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED` + `performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`) AS `full_scans` from `performance_schema`.`events_statements_summary_by_host_by_event_name` where (`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT` <> 0) order by if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`),`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT` desc;
...
-- Dumping structure for table testdb.hibernate_sequence
...
-- Dumping structure for table testdb.tests
...
-- Dumping structure for table testdb.value
